...
public class Motorista extends Usuario {
  ...
  public Motorista(int ativo, String cpf, String nome, String funcao_IFPR, String senha, Date data_nascimento, int idade, String curso, String telefone,
      String endereco, String carteira_motorista) {
    super(ativo, cpf, nome, funcao_IFPR, senha, data_nascimento, idade, curso, telefone, endereco);

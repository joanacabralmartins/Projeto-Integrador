...
public class JanelaCaronaUsuario implements Initializable {
    ...
    private void filtrar() {
      ...
      for(Carona c : caronaList) {
        Carona carona = new Carona(c.getId(), c.getId_motorista(), c.getId_carro(), c.getHorarioSaida(), c.getLugaresDisponiveis(), c.getStatus(), c.getOrigem(), c.getDestino(), c.getDataCadastro(), c.getData());

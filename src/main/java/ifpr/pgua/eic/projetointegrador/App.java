...
import ifpr.pgua.eic.projetointegrador.controllers.JanelaGerenciarPassageiros;
...
public class App extends BaseAppNavigator {
    ...
    public void registrarTelas() {
        ...
        registraTela("USUARIO",
                new ScreenRegistryFXML(getClass(), "fxml/usuario.fxml", (o) -> new JanelaUsuario(motoristaRepository, usuarioRepository, carroRepository, caronaRepository, solicitacaoRepository)));
        ...
        registraTela("SOLICITACOES", new ScreenRegistryFXML(getClass(), "fxml/solicitacao.fxml", 
                (o) -> new JanelaSolicitacoes(solicitacaoRepository, usuarioRepository, caronaRepository)));
        ...
        registraTela("GERENCIAR PASSAGEIROS", new ScreenRegistryFXML(getClass(), "fxml/gerenciar-passageiros.fxml", 
                (o) -> new JanelaGerenciarPassageiros(usuarioRepository, caronaRepository, solicitacaoRepository)));

        registraTela("EDITAR CARONA", new ScreenRegistryFXML(getClass(), "fxml/editar-carona.fxml", 
                (o) -> new JanelaEditarCarona(caronaRepository, carroRepository, motoristaRepository, pontoRepository, solicitacaoRepository)));                
    }
